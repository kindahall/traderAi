...
export const strategies: StrategyDefinition[] = [
  ...
  },
  {
    ...
    drawdown: -6.32,
    validationRate: 68.5,
    assets: ["DOGE/USD", "LINK/USD", "OP/USD"],
  ...
  },
  {
    ...
    drawdown: -12.84,
    validationRate: 64.8,
    assets: ["BTC/USD", "SOL/USD", "XRP/USD"],
  ...
  {
    id: "sub-dollar-momentum",
    name: "Sub-Dollar Momentum",
    status: "active",
    timeframe: "5m",
    risk: "Élevé",
    winRate: 59.4,
    ...
    drawdown: -10.18,
    validationRate: 66.2,
    assets: ["TRX/USD", "SUI/USD", "PEPE/USD", "WIF/USD", "DOGE/USD", "OP/USD"],
    entryRules: ["Prix < 1 $", "Momentum 5m positif", "Volume > moyenne 20 bougies", "Spread normalisé"],
    exitRules: ["Take-profit rapide", "Stop strict sous dernier creux", "Sortie si momentum retombe neutre"],
    filters: ["Liquidité suffisante", "Pas de spike isolé", "Exposition réduite par trade"],
    recommendation: "Utiliser pour petits capitaux, puis confirmer en paper avant toute hausse de taille.",
  },
  {
    id: "scalp-volatility",
    ...
    drawdown: -9.12,
    validationRate: 52.4,
    assets: ["PEPE/USD", "WIF/USD", "LTC/USD"],
